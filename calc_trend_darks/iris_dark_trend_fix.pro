...
;                                       start 2024   
progver = 'v2024.August.06' ;--- (Guliano) V35 (All Ports): Update of model to improve fit
;                                       Utilizes data from 2023 and
;                                       2024 for model generation
;                
progver = 'v2025.January.08' ;--- (Guliano) V36 (All Ports): Update of model to improve fit
;                                      Temporary bridge update duirng JSOC
;                                      outage. 
;     
progver = 'v2025.March.18' ;--- (Guliano) V37 (All Ports): Model E locked in for data 2024/01 through 2024/10/31 utilizes data from parts of 2023, all of 2024, and early 2025 data. Model F introduced.
;
;   
progver = 'v2025.July.07' ;--- (Guliano) V38 (All Ports):All Model F parameters for each port refit for middle of the model to improve alignment
;
;
; ============================================================================                                                 ;
;-
...
;        Amp1      Amp2         P1             Phi1      Phi2           Lin                 Quad           Offset 
D_fuv1=[ 0.15153  , 0.17079  ,  3.2505e+07   , 0.59594  , 1.39868  ,  2.111162363e-07   ,  -4.022355134e-16  ,-16.22893 ]
D_fuv2=[ 0.26958  , 0.26021  ,  3.1710e+07   , 0.35179  , 0.96095  ,  2.513516324e-07   ,  -4.866233828e-16  ,-21.82483 ]
D_fuv3=[ 1.72252  , 1.70486  ,  3.1536e+07   , 0.31451  , 0.85817  ,  2.612385141e-07   ,  -5.562765772e-16  ,-15.43956 ]
D_fuv4=[ 0.31176  , 0.21608  ,  3.2505e+07   , 0.59594  , 1.39868  ,  2.446642441e-07   ,  -4.752284952e-16  ,-19.05676 ]
D_nuv1=[ 0.58896  , 0.56887  ,  3.1442e+07   , 0.29267  , -0.19437 ,  1.689121985e-08   ,  -3.299611697e-17  , 0.16047  ]
D_nuv2=[ 0.70945  , 0.72248  ,  3.1438e+07   , 0.29185  , 0.79957  ,  2.725111171e-08   ,  -4.953088282e-17  , -1.28056 ]
D_nuv3=[ 0.27374  , 0.27203  ,  3.1459e+07   , 0.28776  , 0.81621  ,  5.725664987e-08   ,  -1.163066570e-16  , -2.67818 ]
D_nuv4=[ 0.44648  , 0.44676  ,  3.1457e+07   , 0.29655  , 0.81367  ,  6.168409699e-08   ,  -1.208812150e-16  , -4.00753 ]
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;                              ******MODEL E**********
;              PARAMETERS COVERING 2024/01/01 through 2024/10/31
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

;        Amp1      Amp2         P1             Phi1      Phi2           Lin                 Quad           Offset 
E_fuv1=[ 0.23840  , 0.11959  ,  3.2946e+07   , 0.69944  , 1.81847  ,  7.346767219e-08   ,  -1.814743065e-16  , 5.21829  ]
E_fuv2=[ 0.38421  , 0.21835  ,  3.2160e+07   , 0.45727  , 1.24349  ,  -2.528219460e-07  ,  3.171033202e-16   , 57.10891 ]
E_fuv3=[ 1.83104  , 1.45291  ,  3.1964e+07   , 0.44334  , 1.13597  ,  -4.799976137e-07  ,  6.130669778e-16   ,101.83218 ]
E_fuv4=[ 0.40758  , 0.16464  ,  3.3285e+07   , 0.77466  , 1.94434  ,  9.774825417e-08   ,  -2.483170615e-16  , 4.69555  ]
E_nuv1=[ 0.56512  , 0.49293  ,  3.1547e+07   , 0.32121  , -0.13606 ,  1.692081662e-08   ,  -3.342051242e-17  , 0.20861  ]
E_nuv2=[ 0.70731  , 0.61869  ,  3.1554e+07   , 0.32409  , 0.86686  ,  2.354131966e-08   ,  -4.142066014e-17  , -0.89639 ]
E_nuv3=[ 0.26610  , 0.21561  ,  3.1305e+07   , 0.22642  , 0.71598  ,  1.822440206e-08   ,  -4.823838267e-17  , 2.88396  ]
E_nuv4=[ 0.45567  , 0.38157  ,  3.1692e+07   , 0.36273  , 0.95773  ,  -5.766990873e-08  ,  7.142837369e-17   , 14.48135 ]

;FUV for Model E
if ins eq 0 then begin                     ; if FUV, load up variables
   E_amp1=[E_fuv1(0),E_fuv2(0),E_fuv3(0),E_fuv4(0)]   ; amp of variation with period p1
   E_amp2=[E_fuv1(1),E_fuv2(1),E_fuv3(1),E_fuv4(1)]  ; amp of variation with period p1/2
   E_p1=  [E_fuv1(2),E_fuv2(2),E_fuv3(2),E_fuv4(2)]    ; period of main variation [s]
   E_phi1=[E_fuv1(3),E_fuv2(3),E_fuv3(3),E_fuv4(3)]  ; phase offset for p=p1 variation
   E_phi2=[E_fuv1(4),E_fuv2(4),E_fuv3(4),E_fuv4(4)]  ; phase offset for p=p1/2 variation
   E_lin= [E_fuv1(5),E_fuv2(5),E_fuv3(5),E_fuv4(5)] ; linear long-term trend
   E_quad=[E_fuv1(6),E_fuv2(6),E_fuv3(6),E_fuv4(6)]  ;  quadratic term
   E_off= [E_fuv1(7),E_fuv2(7),E_fuv3(7),E_fuv4(7)]   ; offset constant
   ;STARTING TIME FOR MODEL E
   Model_E_Start =1.4200705e+09 ;2024/01/01 12:01am

;NUV for Model E
endif else begin                          ; if NUV/SJI
   E_amp1=[E_nuv1(0),E_nuv2(0),E_nuv3(0),E_nuv4(0)]
   E_amp2=[E_nuv1(1),E_nuv2(1),E_nuv3(1),E_nuv4(1)]
   E_p1=  [E_nuv1(2),E_nuv2(2),E_nuv3(2),E_nuv4(2)]
   E_phi1=[E_nuv1(3),E_nuv2(3),E_nuv3(3),E_nuv4(3)]
   E_phi2=[E_nuv1(4),E_nuv2(4),E_nuv3(4),E_nuv4(4)]
   E_lin= [E_nuv1(5),E_nuv2(5),E_nuv3(5),E_nuv4(5)]
   E_quad=[E_nuv1(6),E_nuv2(6),E_nuv3(6),E_nuv4(6)]
   E_off= [E_nuv1(7),E_nuv2(7),E_nuv3(7),E_nuv4(7)]
   ;STARTING TIME FOR MODEL E
   Model_E_Start = 1.4200705e+09 ;2024/01/01 12:01am
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;                              ******MODEL F**********
;              PARAMETERS COVERING 2024/11/01 THROUGH ......
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

;        Amp1      Amp2         P1             Phi1      Phi2           Lin                 Quad           Offset 
F_fuv1=[ 0.17631  , 0.20743  ,  3.2633e+07   , 0.58308  , 1.67155  ,  3.029616297e-08   ,  -8.651489068e-17  , 9.05591  ]
F_fuv2=[ 0.32335  , 0.24051  ,  3.2025e+07   , 0.40782  , 1.19016  ,  -2.987631490e-07  ,  3.995501834e-16   , 63.27876 ]
F_fuv3=[ 1.86956  , 1.70450  ,  3.1039e+07   , 0.12637  , 0.51178  ,  -4.045912500e-07  ,  4.943068090e-16   , 89.90080 ]
F_fuv4=[ 0.31619  , 0.21020  ,  3.0310e+07   , -0.19214 , -0.06048 ,  -4.207883430e-07  ,  5.302215357e-16   , 90.90900 ]
F_nuv1=[ 0.64251  , 0.56032  ,  3.1084e+07   , 0.14736  , -0.45261 ,  4.673801723e-08   ,  -7.501413998e-17  , -5.14820 ]
F_nuv2=[ 0.80150  , 0.68844  ,  3.1203e+07   , 0.18914  , 0.62686  ,  1.306919223e-07   ,  -1.975373433e-16  ,-19.29308 ]
F_nuv3=[ 0.32510  , 0.25638  ,  3.1087e+07   , 0.14783  , 0.54632  ,  -1.408938343e-08  ,  5.751933824e-18   , 7.60347  ]
F_nuv4=[ 0.51441  , 0.43127  ,  3.1125e+07   , 0.16059  , 0.56954  ,  -1.077947689e-08  ,  3.116007895e-18   , 6.42802  ]

;FUV for Model F
if ins eq 0 then begin                     ; if FUV, load up variables
   F_amp1=[F_fuv1(0),F_fuv2(0),F_fuv3(0),F_fuv4(0)]   ; amp of variation with period p1
   F_amp2=[F_fuv1(1),F_fuv2(1),F_fuv3(1),F_fuv4(1)]  ; amp of variation with period p1/2
   F_p1=  [F_fuv1(2),F_fuv2(2),F_fuv3(2),F_fuv4(2)]    ; period of main variation [s]
   F_phi1=[F_fuv1(3),F_fuv2(3),F_fuv3(3),F_fuv4(3)]  ; phase offset for p=p1 variation
   F_phi2=[F_fuv1(4),F_fuv2(4),F_fuv3(4),F_fuv4(4)]  ; phase offset for p=p1/2 variation
   F_lin= [F_fuv1(5),F_fuv2(5),F_fuv3(5),F_fuv4(5)] ; linear long-term trend
   F_quad=[F_fuv1(6),F_fuv2(6),F_fuv3(6),F_fuv4(6)]  ;  quadratic term
   F_off= [F_fuv1(7),F_fuv2(7),F_fuv3(7),F_fuv4(7)]   ; offset constant
   ;STARTING TIME FOR MODEL E
   Model_F_Start =1.4464188e+09 ;2024/11/01 12:00am

;NUV for Model F
endif else begin                          ; if NUV/SJI
   F_amp1=[F_nuv1(0),F_nuv2(0),F_nuv3(0),F_nuv4(0)]
   F_amp2=[F_nuv1(1),F_nuv2(1),F_nuv3(1),F_nuv4(1)]
   F_p1=  [F_nuv1(2),F_nuv2(2),F_nuv3(2),F_nuv4(2)]
   F_phi1=[F_nuv1(3),F_nuv2(3),F_nuv3(3),F_nuv4(3)]
   F_phi2=[F_nuv1(4),F_nuv2(4),F_nuv3(4),F_nuv4(4)]
   F_lin= [F_nuv1(5),F_nuv2(5),F_nuv3(5),F_nuv4(5)]
   F_quad=[F_nuv1(6),F_nuv2(6),F_nuv3(6),F_nuv4(6)]
   F_off= [F_nuv1(7),F_nuv2(7),F_nuv3(7),F_nuv4(7)]
   ;STARTING TIME FOR MODEL E
   Model_F_Start =1.4464188e+09 ;2024/11/01 12:00am
...
;                       MODEL E
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
model_E_offsets = E_amp1 *sin(c*(dt0/E_p1 + E_phi1)) +  $
           E_amp2 *sin(c*(dt0/(E_p1/2) + E_phi2)) +  $
           E_lin*dt0  + E_quad*dt0^2 + E_off

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;                       MODEL F
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
model_F_offsets = F_amp1 *sin(c*(dt0/F_p1 + F_phi1)) +  $
           F_amp2 *sin(c*(dt0/(F_p1/2) + F_phi2)) +  $
           F_lin*dt0  + F_quad*dt0^2 + F_off
...
model_E_time = (dt0 ge model_E_start - t0[k]) and (dt0 lt model_F_start - t0[k])
model_F_time = (dt0 ge model_F_start - t0[k])

;will be 1 for correct model and 0 for incorect
;creating a final offsets array using only correct models
offsets =  (model_A_offsets*model_A_time) + (model_B_offsets*model_B_time) + (model_C_offsets*model_C_time) + (model_D_offsets*model_D_time)  + (model_E_offsets*model_E_time)  + (model_F_offsets*model_F_time)

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;Turn this one for offset_printing
; USE THIS FORMAT TO RUN
;iris_dark_trend_fix, '2024/10/31T23:00:01', off, 'FUV'
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
