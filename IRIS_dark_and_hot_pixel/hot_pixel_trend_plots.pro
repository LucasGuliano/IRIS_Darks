...
if not keyword_set(year_list) then year_list=['2014','2015', '2016','2017','2018', '2019', '2020', '2021']
...
;	hot_arr30s = intarr(4,(n_elements(year_list)*12))
	...
	if cutoff eq 1. then begin
		plot, juldays0s[*,0], hot_arr0s[*,0], /nodata, Background=cgColor('white'),Color=cgColor('black'), xtickformat='label_date', xstyle=1, $
			...
			charthick=2,charsize=1.7,xgridstyle=1,ygridstyle=1,xticklen=1,yticklen=1,font=1, POSITION=[0.1, 0.1, 0.9, 0.95]
	endif else begin
...
;	oplot, juldays30s, hot_arr30s[3,*], color=cgColor('purple'), psym=6
	...
	al_legend, labels, Color=['purple','purple','purple','purple',cgColor('charcoal')],thick=[3,3,3,3,2], LineStyle=[0,1,2,4,2], /right, charsize=1.5
