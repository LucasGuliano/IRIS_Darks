...
def main():
    ...
    outc = 0 #zero means all is good, start with default

    darkf = "processed_dark_months.txt"
    prev = open(darkf,"r")
    check = prev.readlines()

    #Look back at timelines for a given amount of days (span) to find one with the correct dark OBSID
