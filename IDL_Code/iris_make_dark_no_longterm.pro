...
pro iris_make_dark_no_longterm, index, dark, temps, time_tab, temp_tab, levels, $
	progver = progver
...
;       temperatures and exposure time, WITHOUT the longterm fix
;  
; CALLING SEQUENCE:
;
; INPUTS:
